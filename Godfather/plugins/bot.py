...
from Godfather import OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY, flameversion
...
FLAME_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/e4acd32d8f8f64591a2a0.jpg"
  

FLAME = "✯ FLAME SPAM HERE ✯\n\n"
FLAME += f"═══════════════════\n"
FLAME += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.10.1`\n"
FLAME += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
FLAME += f"• **flameʙᴏᴛ ᴠᴇʀsɪᴏɴ**  : `{flameversion}`\n"
FLAME += f"═══════════════════\n\n"   
