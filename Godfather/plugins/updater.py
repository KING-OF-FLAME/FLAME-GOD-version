...
OFFICIAL_UPSTREAM_REPO = "https://github.com/KING-OF-FLAME/FLAME-GOD-version/"
BOT_IS_UP_TO_DATE = "**The Flame Spam Bot** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your Flame Spam Bot..."
)
...
async def restart(e):
    if e.sender_id == OWNER_ID:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗬𝗼𝘂𝗿 Flame 𝗨𝘀𝗲𝗿𝗯𝗼𝘁𝘀__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗰𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
...
async def deploy_start(SAM, message, refspec, remote):
    ...
    await message.edit(
        "Updated your Flame Spam Bot successfully sur!!!\n© @thekingofflame786"
    )
